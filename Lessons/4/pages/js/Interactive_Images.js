...
function loadOne(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        $('.contents .row').append('<div class="col-xs-12"><div class="image_thumb wow zoomIn"><a href="javascript:void(0)"><img id="'+x1+'" class="img-responsive center-block" src="'+mydata.dynamicData[x1].image+'"/></a><div class="img_desc"><p class="title_font">'+mydata.dynamicData[x1].text+'</p></div></div></div>');
    }    
}

function loadTwo(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        $('.contents .row').append('<div class="col-xs-12 col-sm-6"><div class="image_thumb wow zoomIn"><a href="javascript:void(0)"><img id="'+x1+'"  class="img-responsive center-block" src="'+mydata.dynamicData[x1].image+'"/></a><div class="img_desc"><p class="title_font">'+mydata.dynamicData[x1].text+'</p></div></div></div>');
    }
}
...
function loadThrees(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        ...
        $('.contents .row').append('<div class="col-xs-12 col-md-4 col-sm-4"><div class="image_thumb wow zoomIn"><a href="javascript:void(0)"><img id="'+x1+'" class="img-responsive center-block" src="'+mydata.dynamicData[x1].image+'"/></a><div class="img_desc"><p class="title_font">'+mydata.dynamicData[x1].text+'</p></div></div></div>');
    }
}
...
function loadFours(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        ...
        $('.contents .row').append('<div class="col-xs-12 col-md-3 col-sm-3"><div class="image_thumb wow zoomIn"><a href="javascript:void(0)"><img id="'+x1+'" src="'+mydata.dynamicData[x1].image+'"/></a><div class="img_desc"><p class="title_font">'+mydata.dynamicData[x1].text+'</p></div></div></div>');
    }
}