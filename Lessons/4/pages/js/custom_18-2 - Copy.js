...
  for ( var i=0; i<DG.length; i++ ) {
    $('<div  class="grid-md-2 grid-sm-4 grid-xs-3"><div class="sec_item"><div class="sec_img"><img src="' + cardsSrc[i].y + '" alt=""/></div><div class="sec_num"></div><p class="sec_desc">' + cardsSrc[i].z  + '</p></div></div>').data( 'number', cardsSrc[i].x ).appendTo( '.section_items' ).droppable( {
