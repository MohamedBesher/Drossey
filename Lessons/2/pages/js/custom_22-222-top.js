...
/*    $('<div class="row"> <div class="col-md-3 col-sm-3 col-xs-3">  <nav class="temp_22_nav">  </nav></div><!--end col-xs-12--> <div class="col-md-9 col-sm-9 col-xs-9"> <div class="blue_bg"> <div class="science_temp"> <img src="'+pages[pageNum].main_img+'"/></div> </div><!--end blue_bg--> </div><!--end col-xs-12--> </div><!--end row-->').appendTo('.contents')*/
    ...
    $('<div class="row" style="font-size:'+pages[pageNum].col_font+'px"> <nav class="temp_22_nav" >  </nav></div><div class="row"> <div class="blue_bg col-md-12 col-sm-12 col-xs-12"  > <div class="science_temp"> <img src="'+pages[pageNum].main_img+'" style="'+pages[pageNum].style+'"/></div> </div><!--end blue_bg--> </div><!--end col-xs-12--> </div><!--end row-->').appendTo('.contents')
