...
$(document).ready(function() {
    // this key code to link with player and load json 
     /*   loadScript('../Player/js/redundant.js', function (a, b) {}).onload = function () {
        loadScript('../Player/lessons/' + lessonID + '/media/Tabs_Up20.js', function (a, b) {}).onload = function () {*/
...
//            $('.contents article p').css('column-gap','40px');
        ...
        //image only
            ...
            $('#allcontents'+newn).html('<div class="col-xs-12 col-md-12 col-sm-12"><div class="contents"><img src="'+mydata.dynamicData[newn].mediaSource+'" style="'+mydata.dynamicData[newn].style+'" /></div></div>');
        ...
        //text with image
            ...
            $('#allcontents'+newn).html('<div class="col-xs-6 col-md-6 col-sm-6"><article><p>'+mydata.dynamicData[newn].paragraph+'</p></article></div><div class="col-xs-6 col-md-6 col-sm-6"><img src="'+mydata.dynamicData[newn].mediaSource+'" style="'+mydata.dynamicData[newn].style+'"/></div>');
...
function loadSlider(newn){
    ...
    for(var nn=0;nn<mydata.dynamicData[newn].mediaSource.length;nn++){
        ...
        $('#carousel'+newn+' .carousel-inner').append('<div class="item"><img src="'+mydata.dynamicData[newn].mediaSource[nn]+'" style="'+mydata.dynamicData[newn].style+'"></div>');
    }
