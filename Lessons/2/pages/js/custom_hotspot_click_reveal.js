...
function init(pageNum) {
    ...
    if(hotspot[pageNum][0].narration!=undefined ){
        if(hotspot[pageNum][0].narration!=""){playTapAudio(hotspot[pageNum][0].narration);}    
    }  
};
...
function displayMaps(maps_array){
    ...
    if(maps_array[0].main_img_src==""){
        $("#div_content").append("<img src='data:image/png;base64,'  alt='' usemap='#map'><map name='map' id='map'></map>") ;
        ...
        $.each(itemsDetails,function(index,item){
            ...
            $("#markers").append("<a tabindex='0' class='hotspot_pop' data-placement='"+place+"' style=\"top: "+top+"%; left: "+left+"%;\"  data-toggle='popover' data-trigger='focus' title='"+popOverTitle+"' data-content='"+d_text+"' ></a>");
        });}
        else{
    $("#div_content").append("<img src='"+maps_array[0].main_img_src+"'  alt='' usemap='#map'><map name='map' id='map'></map>") ;
var itemsDetails = maps_array[0].items_data,place;
    itemsDetails_length = itemsDetails.length;
    $.each(itemsDetails,function(index,item){
        place="top";
