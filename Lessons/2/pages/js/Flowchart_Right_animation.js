...
//    
        ...
        $('.blue_bg .row').append('<div id="articalContant" class="col-md-6 col-sm-6 col-xs-12"></div>');
         $(mydata.dynamicData[num].paragraph).each(function(index,value){
             if(index==0)
                id.push(setTimeout(function(){ $('.blue_bg .row #articalContant').append('<article>'+value.text+'</article>');},value.time));
            else
        ...
        $('.blue_bg .row').append('<div class="col-md-6 col-sm-6 col-xs-12 text-center"><div class="media_cont"></div></div>');
