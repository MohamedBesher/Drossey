...
function load_tooltip_content(){
    ...
    if(mydata.mediaType=='text'){
        ...
        $('.contents .row').append('<div class="col-xs-12 col-md-6 col-sm-8"><article><p></p></article></div><div class="col-xs-12 col-md-6 col-sm-4"><div class="media_cont"><img src="'+mydata.mediaSource+'" alt="" style="'+mydata.style+'"/></div></div>');
