...
function loadLinks(){        
    for(var x=0;x<mydata.dynamicData.length;x++){
        var d=x+1;
        $('.carousel-inner').append('<div class="item"><img src="'+mydata.dynamicData[x].image+'" style="'+mydata.dynamicData[x].style+'"><article style="height:'+mydata.dynamicData[x].height+'"><p>'+mydata.dynamicData[x].paragraph+'</p></article></div>');
