...
//            $('.contents article p').css('column-gap','40px');
        ...
        //image only
             ...
             id.push(setTimeout(function(){  $('#allcontents').html('<div class="col-xs-12 col-md-12 col-sm-12"><div class="contents"><img src="'+mydata.dynamicData[newn].mediaSource.src+'" class="animated zoomIn" style="'+mydata.dynamicData[newn].style+'"/></div</div>');}, mydata.dynamicData[newn].mediaSource.time));
