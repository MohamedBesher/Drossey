...
$(document).ready(function() {
  ...
  /*      loadScript('../Player/js/redundant.js', function (a, b) {}).onload = function () {
        loadScript('../Player/lessons/' + lessonID + '/media/Slider_Text20.js', function (a, b) {}).onload = function () {*/
...
function loadLinks(){
    ...
    for(var x=0;x<mydata.dynamicData.length;x++){
        ...
        $('.carousel-inner').append('<div class="item"><img src="'+mydata.dynamicData[x].image+'" style="'+mydata.dynamicData[x].style+'"><article><p>'+mydata.dynamicData[x].paragraph+'</p></article></div>');
    }
