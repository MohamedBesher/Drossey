...
    $('<div class="grid-xs-'+pages[pageNum].num_images+'" style="margin-top:10px"><div class="card_img"><img src="' + answers[i].y + '" alt=""/></div></div>').appendTo( '#cardPile' ).children(".card_img").data( 'number', answers[i].x ).draggable( {
...
    $('<div class="grid-xs-3 " ><div class="drop-place"><div class="row"><div class="col-xs-12 col-sm-6 col-md-6"><div class="card_drop"></div></div><div class="card-desc col-xs-12 col-sm-6 col-md-6">'+ DQ[i-1].question + '</div></div></div></div>').data( 'number', i ).appendTo( '#cardSlots' ).droppable( {     
