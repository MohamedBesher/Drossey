$(function(){
    ...
    var lesson_id=  sessionStorage.getItem('lessonId');
         ...
         loadScript("../Data/Lessons/"+lesson_id+"/"+jsonFile+".js",function (a, b) {}).onload = function ()
        {
           ...
           if(json.title != undefined  && json.inside_title != undefined && json.pageHeader != undefined)
               {
                 ...
                 $(json.equations).each(function(j,text){  
                     ...
                     $("#text_div").append('<div class="item col-xs-12"><span class="firstside col-md-5  col-sm-5 col-xs-5">'+text[0]+'</span><span class="OP col-md-1 col-xs-1 col-sm-1"><div id="'+text[1]+'" class="ui-widget-header" > </div></span><span class="secondside col-md-5 col-sm-5 col-xs-5">'+text[2]+'</span></div>');
                     //print text here 
