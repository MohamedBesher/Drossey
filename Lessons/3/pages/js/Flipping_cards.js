        ...
        for(var x1=0;x1<mydata.dynamicData.activeData.length;x1++){
            if(mydata.dynamicData.activeData.length==1){
                ...
                if(mydata.dynamicData.activeData[x1].frontPic != ''){
                    $('#active'+x1+' .front_box').prepend('<img src="'+mydata.dynamicData.activeData[x1].frontPic+'" style="'+mydata.dynamicData.activeData[x1].style+'" />');
                }
                ...
                $('.item1').append('<div class="col-xs-12 col-md-4 col-sm-4"><div class="box_text" id="active'+x1+'"><div class="front_box"><p></p></div><div class="back_box"><p></p></div></div></div>');
    ...
    if(mydata.dynamicData.otherData.length != 0){        
        for(var x2=0;x2<mydata.dynamicData.otherData.length;x2++){
            if(mydata.dynamicData.otherData.length==1){
                ...
                $('.item2').append('<div class="col-xs-12 col-md-4 col-sm-4"><div class="box_text" id="other'+x2+'"><div class="front_box"><p></p></div><div class="back_box"><p></p></div></div></div>');
...
//                narration=document.getElementById('narration');
                canPlayMP3 = (typeof narration.canPlayType === "function" && narration.canPlayType("audio/mpeg") !== "");
                narration.src=mydata.dynamicData.activeData[$(this).parent().index()].sub_narration+'.mp3';
                narration.load();
                narration.play();
            }else{
//                narration.pause();
...
//                narration=document.getElementById('narration');
                canPlayMP3 = (typeof narration.canPlayType === "function" && narration.canPlayType("audio/mpeg") !== "");
                narration.src=mydata.dynamicData.otherData[$(this).parent().index()].sub_narration+'.mp3';
                narration.load();
                narration.play();
            }else{
//                narration.pause();
