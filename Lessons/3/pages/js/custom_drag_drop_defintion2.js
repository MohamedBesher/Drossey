...
    $('<div class="grid-xs-5"><div class="card_number">' + answers[i].y + '</div></div>').appendTo( '#cardPile' ).children(".card_number").data( 'number', answers[i].x ).draggable( {
...
    $('<div class="grid-xs-3"><div class="drop-place"><div class="card_word"></div><p class="card-desc">' + itemsData[i-1].definition + '</p></div></div>').appendTo( '#cardSlots' ).children().children(".card_word").data( 'number', i ).droppable( {     
