...
$(document).ready(function() {
    ...
    // this key code to link with player and load json 
     /*   loadScript('../Player/js/redundant.js', function (a, b) {}).onload = function () {
        loadScript('../Player/lessons/'+lessonID+'/media/Interactive_Images_Popup.js', function (a, b) {}).onload = function () {*/
...
function loadOne(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        $('.contents .row').append('<div class="col-xs-12"><div id="'+x1+'" class="image_title wow bounceIn"><img data-toggle="modal" data-target="#text_modal" src="'+mydata.dynamicData[x1].image+'" style="'+mydata.dynamicData[x1].style+'" /><a href="javascript:void(0)" data-toggle="modal" data-target="#text_modal">'+mydata.dynamicData[x1].sample+'</a></div></div>');
    }    
}

function loadTwo(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        $('.contents .row').append('<div class="col-xs-12 col-sm-6"><div id="'+x1+'" class="image_title wow bounceIn"><img data-toggle="modal" data-target="#text_modal" src="'+mydata.dynamicData[x1].image+'" style="'+mydata.dynamicData[x1].style+'" /><a href="javascript:void(0)" data-toggle="modal" data-target="#text_modal">'+mydata.dynamicData[x1].sample+'</a></div></div>');
    }
}
...
function loadThrees(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
       ...
       /* $('.contents .row').append('<div class="col-xs-4 col-md-4 col-md-4><div  "style="padding-right: 0px; padding-left: 0px;" id="'+x1+'" class="image_title wow bounceIn"><img data-toggle="modal" data-target="#text_modal" src="'+mydata.dynamicData[x1].image+'"/><a href="javascript:void(0)" data-toggle="modal" data-target="#text_modal">'+mydata.dynamicData[x1].sample+'</a></div></div>');*/
      $('.contents .row').append('<div class="col-xs-12 col-md-4 col-sm-4"><div id="'+x1+'" class="image_title wow bounceIn"><img data-toggle="modal" data-target="#text_modal" src="'+mydata.dynamicData[x1].image+'" style="'+mydata.dynamicData[x1].style+'" /><a href="javascript:void(0)" data-toggle="modal" data-target="#text_modal">'+mydata.dynamicData[x1].sample+'</a></div></div>');
    }
}
...
function loadFours(){
    for(var x1=0;x1<mydata.dynamicData.length;x1++){
        ...
        $('.contents .row').append('<div class="col-xs-12 col-md-3 col-sm-3"><div id="'+x1+'" class="image_title wow bounceIn"><img data-toggle="modal" data-target="#text_modal" src="'+mydata.dynamicData[x1].image+'" style="'+mydata.dynamicData[x1].style+'" /><a href="javascript:void(0)" data-toggle="modal" data-target="#text_modal">'+mydata.dynamicData[x1].sample+'</a></div></div>');
    }
}
