...
function setGallery(location, dataG,gType) {
    ...
    for (var i=0;i<dataG.length;i++) {
        ...
        innertHTML='<div class="row"><div class="col-md-7 col-xs-12"><img src="'+dataG[i].main_src+'" class="img_shadow" alt="..."></div><!--end col-md-9 col-xs-12--><div class="col-md-5 col-xs-12"><div class="slide_content"><h3 class="title_font">'+dataG[i].title+'</h3><p>'+dataG[i].desc+'</p></div><!--end slide_content--></div><!--end col-md-3 col-xs-12--><div class="clearfix"></div></div><!--end row-->'
        }else {
        // this code for normal slide in page 14
        innertHTML='<img src="'+dataG[i].main_src+'" alt="..."><div class="carousel-caption"><h3 class="title_font">'+dataG[i].title+'</h3><p>'+dataG[i].desc+'</p></div>'
        }
...
function setGallary(location,className){
    ...
    if(pages[currentPage].article!=undefined){$(location).append('<div class="row"><div class="col-md-6 col-sm-6 col-xs-6 "><h2 class="title_font page_title"></h2><p class="page_desc text-justify"></p> </div><!--end col-xs-12--><div class="col-md-6  col-sm-6  col-xs-6"><div class="gallery '+className+' "> </div><!--end gallery--></div><!--end col-xs-10--><!--end row-->')}else{ $(location).append(' <div class="row"><div class="col-xs-8 col-xs-offset-2"><div class="gallery '+className+' "> </div><!--end gallery--> </div></div>')}
