...
$(function(){
   ...
   /* loadScript('../Player/js/redundant.js', function (a, b) {}).onload = function () {
        loadScript('../Player/lessons/' + lessonID + '/media/Flowchart_Down.js', function (a, b) {}).onload = function () { */
...
function loadTabContent(num){
    if(mydata.dynamicData[num].type=='text'){
        ...
        $('.blue_bg .row').html('<div class="col-md-8 col-sm-8 col-xs-8"><h4 class="text-line">'+mydata.dynamicData[num].paragraph+'</h4></div><div class="col-md-4 col-sm-4 col-xs-4 text-center" ><img src="'+mydata.dynamicData[num].mediaSource+'"/></div>');
        ...
        $('.blue_bg .row').html('<div class="col-md-8 col-sm-8 col-xs-8"><h4 class="text-line">'+mydata.dynamicData[num].paragraph+'</h4></div><div class="col-md-4 col-sm-4 col-xs-4 text-center" ><div class="media_cont"></div></div>');
