...
function tab_content(slide,btn){
    ...
    if(mydata.dynamicData[slide].left_hand[btn].content.type == 'text'){
        ...
        $('.item:nth-child('+item_num+') .temp_box .temp_tab .tab_content').html('<div class="col-xs-6 col-md-6 col-sm-6"><h4>'+mydata.dynamicData[slide].left_hand[btn].content.paragraph+'</h4></div><div class="col-xs-6 col-md-6 col-sm-6"><img src="'+mydata.dynamicData[slide].left_hand[btn].content.mediaSource+'"/></div>');
...
//    }    
    ...
    if(mydata.dynamicData[slide].left_hand[btn].sub_narration != undefined && mydata.dynamicData[slide].left_hand[btn].sub_narration != ''){
        ...
        narration.src=canPlayMP3?mydata.dynamicData[slide].left_hand[btn].sub_narration+'.ogg':mydata.dynamicData[slide].left_hand[btn].sub_narration+'.mp3';
        narration.load();
        narration.play();
...
function play_firstTab_audio(slideTo){
    narration=document.getElementById('narration');
    canPlayMP3 = (typeof narration.canPlayType === "function" && narration.canPlayType("audio/mpeg") !== "");
    narration.src=canPlayMP3?mydata.dynamicData[slideTo].left_hand[0].sub_narration+'.ogg':mydata.dynamicData[slideTo].left_hand[0].sub_narration+'.mp3';
    narration.load();
    narration.play();
    $('#narration').on('ended', function() {
            narration.pause();
...
function onsliding(slideTo){
    //play tab narration
        ...
        if(mydata.dynamicData[slideTo].right_hand.narration != undefined && mydata.dynamicData[slideTo].right_hand.narration != ''){
            ...
            narration.src=canPlayMP3?mydata.dynamicData[slideTo].right_hand.narration+'.ogg':mydata.dynamicData[slideTo].right_hand.narration+'.mp3';
            narration.load();
            narration.play();
