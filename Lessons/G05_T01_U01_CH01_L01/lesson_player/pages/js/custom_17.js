...
//end
 ...
 // set select
$('<div class="col-md-3 col-sm-3 col-xs-4"><div class="form-group"><label for="'+mySelect+'">'+DG[i].question+'</label><select class="form-control" id="'+mySelect+'">'+seloption+'</select></div></div><!--end col-md-3 col-sm-3 col-xs-12-->' ).appendTo( '#main_content' );
