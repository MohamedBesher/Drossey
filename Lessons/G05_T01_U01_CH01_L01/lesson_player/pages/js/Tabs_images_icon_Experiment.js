...
$(document).ready(function() {
    ...
    /*    loadScript('../Player/js/redundant.js', function (a, b) {}).onload = function () {
        loadScript('../Player/lessons/' + lessonID + '/media/Tabs_images_icon_Experiment.js', function (a, b) {}).onload = function () {*/
...
function loadTabs(){
    for(var n=0; n<mydata.dynamicData.length; n++){
        if(mydata.dynamicData.length==1){
            if(mydata.dynamicData[n].icon != ''){
                $( ".nav-tabs" ).append('<div class="col-xs-12 col-md-12 col-sm-12"><a data-toggle="tab" href="#'+n+'tab" class="lesson_link shadow_eff wow bounceIn " data-wow-delay=".3s">'+mydata.dynamicData[n].title+'<img class="icon" style="max-height:40px" src="'+mydata.dynamicData[n].icon+'"/></a></div>');
            }else{
            ...
            if(mydata.dynamicData[n].icon != ''){
                $( ".nav-tabs" ).append('<div class="col-xs-6 col-md-6 col-sm-6"><a data-toggle="tab" href="#'+n+'tab" class="lesson_link shadow_eff wow bounceIn " data-wow-delay=".3s">'+mydata.dynamicData[n].title+'<img class="icon" style="max-height:40px" src="'+mydata.dynamicData[n].icon+'"/></a></div>');
            }else{
            ...
            if(mydata.dynamicData[n].icon != ''){
                $( ".nav-tabs" ).append('<div class="col-xs-4 col-md-4 col-sm-4"><a data-toggle="tab" href="#'+n+'tab" class="lesson_link shadow_eff wow bounceIn " data-wow-delay=".3s">'+mydata.dynamicData[n].title+'<img class="icon" style="max-height:40px" src="'+mydata.dynamicData[n].icon+'"/></a></div>');
            }else{
            ...
            if(mydata.dynamicData[n].icon != ''){
                $( ".nav-tabs" ).append('<div class="col-xs-3 col-md-3 col-sm-3"><a data-toggle="tab" href="#'+n+'tab" class="lesson_link shadow_eff wow bounceIn " data-wow-delay=".3s">'+mydata.dynamicData[n].title+'<img class="icon" style="max-height:40px" src="'+mydata.dynamicData[n].icon+'"/></a></div>');
            }else{
            ...
            if(mydata.dynamicData[n].icon != ''){
                $( ".nav-tabs" ).append('<div class="col-xs-2 col-md-2 col-sm-2"><a data-toggle="tab" href="#'+n+'tab" class="lesson_link shadow_eff wow bounceIn " data-wow-delay=".3s">'+mydata.dynamicData[n].title+'<img class="icon" style="max-height:40px" src="'+mydata.dynamicData[n].icon+'"/></a></div>');
            }else{
    ...
    $('.lesson_link').click(function(){
        ...
        if(mydata.dynamicData[$(this).parent().index()].sub_narration != undefined && mydata.dynamicData[$(this).parent().index()].sub_narration != ''){
            narration=document.getElementById('narration');
            canPlayMP3 = (typeof narration.canPlayType === "function" && narration.canPlayType("audio/mpeg") !== "");
            narration.src=canPlayMP3?mydata.dynamicData[$(this).parent().index()].sub_narration+'.ogg':mydata.dynamicData[$(this).parent().index()].sub_narration+'.mp3';
            narration.load();
            narration.play();
            $('#narration').on('ended', function() {
                narration.pause();
...
function loadTabContent(){
    for(var newn=0;newn<mydata.dynamicData.length;newn++){
        ...
        if(mydata.dynamicData[newn].type=='text'){
            $('#allcontents'+newn).html('<div class="col-xs-12"><div class="contents"><article><p>'+mydata.dynamicData[newn].paragraph+'</p></article></div></div>');
...
//            $('.contents article p').css('column-gap','40px');
        ...
        //image only
            ...
            $('#allcontents'+newn).html('<div class="col-xs-12"><div class="contents"><img src="'+mydata.dynamicData[newn].mediaSource+'"/></div></div>');
        
        //video only
        }else if(mydata.dynamicData[newn].type=='video'){
            $('#allcontents'+newn).html('<div class="col-xs-12"><div class="contents"><video id="'+video_number+'" controls style="width:100%"><source src="'+mydata.dynamicData[newn].mediaSource+'.ogv" type="video/ogg"/><source src="'+mydata.dynamicData[newn].mediaSource+'.mp4" type="video/mp4"/></video></div></div>');
        
            video_number++;
            
        //slider only
        }else if(mydata.dynamicData[newn].type=='slider'){
            $('#allcontents'+newn).html('<div class="col-xs-12"><div class="contents"><div class="media_cont" id="media_cont'+newn+'"></div></div></div>');
