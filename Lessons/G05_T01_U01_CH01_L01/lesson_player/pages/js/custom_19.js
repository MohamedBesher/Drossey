...
    $('<div class="drag_text "><div class="row"><div class="col-md-6 col-xs-8 text-justify"><p class="drag_ques">' + DG[i-1].question + '</p></div><div class="col-md-6 col-xs-4"><div class="empty_drag"></div></div></div></div>').data( 'number', i ).appendTo( '.section_items' ).droppable( {
      accept: '.panel_drag',
      hoverClass: 'hovered',
      drop: handleCardDrop
    } );
