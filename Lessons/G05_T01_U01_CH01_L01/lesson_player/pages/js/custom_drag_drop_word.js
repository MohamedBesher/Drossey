...
function setCardsDragROW(location){
   $(location).append('<div class="row"><div class="cards_content"><div id="cardPile" class="col-md-4 col-sm-5 col-xs-5" ></div><div class="col-md-4 col-sm-2 col-xs-2"></div><div id="cardSlots" class="col-md-4 col-sm-5 col-xs-5"></div><div class="clearfix"></div></div><!--end fliping_content--></div><!--end row-->')
}
