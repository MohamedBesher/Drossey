...
function setNewHeader(location){
   $(location).html('<div class="alhaytham_head"> <div class="container-fluid"><div class="row"><div class="col-xs-12"><h1 id="lesson_title" class="title_font"></h1><!--end lesson_title--><div class="clearfix"></div></div><!--end col-xs-12--></div><!--end row--></div><!--end container--></div>')
...
function playAudio(path,fName){
    $('<audio id="audioDemo" controls preload="auto"><source src="'+path+'/'+fName+'.mp3" type="audio/mp3"><source src="'+path+'/'+fName+'.ogg" type="audio/ogg"></audio>')[0].play()
...
function playTapAudio(pathWithOutExtention){
    ...
    audioTap=$('<audio id="audioDemo" controls preload="auto"><source src="'+pathWithOutExtention+'.mp3" type="audio/mp3"><source src="'+pathWithOutExtention+'.ogg" type="audio/ogg"></audio>')
    audioTap[0].play()}
