	...
	$.fn.acornMediaPlayer = function(options) {
		...
		var acornPlayer = function() {
			...
			*/
			 ...
			 */
			var fullscreenBtnMarkup = (acorn.$self.is('video')) ? '<button class="acorn-fullscreen-button" title="' + text.fullscreenTitle + '" aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '">' + text.fullscreen + '</button>' : '';
			...
			var template = '<div class="acorn-controls">' +
								'<button class="acorn-play-button" title="' + text.playTitle + '" aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '">' + text.play + '</button>' +
								'<input type="range" class="acorn-seek-slider" title="' + text.seekTitle + '" value="0" min="0" max="150" step="0.1" aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '"/>' +
								'<span class="acorn-timer">00:00</span>' +
								'<div class="acorn-volume-box">' +
									'<button class="acorn-volume-button" title="' + text.mute + '" aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '">' + text.mute + '</button>' +
									'<input type="range" class="acorn-volume-slider" title="' + text.volumeTitle + '" value="1" min="0" max="1" step="0.05" aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '"/>' +
								'</div>' +
								fullscreenBtnMarkup +
								'<button class="acorn-caption-button" title="' + text.captionsTitle + '"  aria-$('.site_contents').html($('<div class="video_cont"> <video class="main_content" autoplay controls="controls" controlsList="nodownload" "' + acorn.id + '">' + text.captions + '</button>' +
