...
var setSlider = function(imgs) {
    ...
    $.each(imgs,function(index,value){
        ...
        imgTemp+='<div class="item '+className+'"><img src="'+value.img+'" class="animated zoomIn"></div>';
        className=""
    })
...
function loadTemplateBody(){
    var setIMediaIsFound=function(value){
        ...
        if( value.img != undefined  ){
            media='<div id="media_img"  '+tempClass+'><img src="'+value.img+'"  class="animated zoomIn" /></div>'
