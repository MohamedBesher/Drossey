...
var anchor_offset;
var height_menu;
($("#scrollspy").offset()) ? anchor_offset = $("#scrollspy").offset().top:'';
 
($('#scrollspy').height()) ? height_menu = $('#scrollspy').height():'';
...
$(document).ready(function() {
  ...
  $('.Edit__password__button').click(function(){
    $('.change__password').css('display', 'block');
    $('.EditInfo').css('display', 'none');

  });
  $('.Back__button').click(function(){
    $('.change__password').css('display', 'none');
