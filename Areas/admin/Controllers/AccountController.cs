    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(AdminLoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    if (! await _userManager.IsInRoleAsync(user,EnumRoles.Administrator.ToString()))
                    {
                        ModelState.AddModelError("", "كلمة المرور او اسم المستخدم خطأ .");
                        return View(model);
                    }
                }
                ...
                {
                    ModelState.AddModelError(string.Empty, "كلمة المرور او اسم المستخدم غير صحيح");
                    return View(model);
                }
            }
        ...
        private async Task AddTokensToCookie(ApplicationUser user, string password)
        {
                ...
                List<Claim> claims = new List<Claim>
            {
                ...
                //await AuthenticationHttpContextExtensions.SignInAsync(this.HttpContext, "AdminAuth", principal);
